...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "INSERT INTO activite (nom, description, capacite, date_debut, date_fin, disponibilite) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssissi", $nom, $description, $capacity, $date_debut, $date_fin, $disponibilite);
    
    if ($stmt->execute()) {
        echo '<script>alert("Activity inserted successfully")</script>';
    } else {
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./createMembre.php">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Create membres</span>
            </a>
          </li>
          <li class="nav-item">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Activity create</h4>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="capacity" placeholder="Entrer la capacity" name="capacity">
                    </div>
                    <div class="form-group">
