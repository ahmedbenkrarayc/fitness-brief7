...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $activity = $_POST['id_activite'];
    $membre = $_SESSION['id'];
    $status = 'confirmee';

    $sql = "INSERT INTO reservation (id_membre, id_activite, date_reservation, status) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("iiss", $membre, $activity, date('Y-m-d H:i:s'), $status);
